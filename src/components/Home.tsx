...
import image from "../assets/busapp.png"; 
import image3 from "../assets/img_03.png"; 
...
export const Home = () => {
  return (
    <>
     <HeroHome /> 
    <section id="home" className="container py-6 sm:py-12 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {home.map(({ title, description, image, href }: FeatureProps) => (
