...
// Definimos la interfaz para las props del componente CustomModalResp
interface CustomModalRespProps {
  show: boolean;
  handleClose: () => void; // Función sin parámetros que se utiliza para cerrar el modal
  response: Response | null; // Puede ser un objeto Response o null
}
